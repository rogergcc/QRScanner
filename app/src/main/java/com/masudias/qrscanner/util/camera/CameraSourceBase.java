 ...
 * {@link CameraSourceBase.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSourceBase {
    ...
    public static class Builder {
        ...
        private CameraSourceBase mCameraSource = new CameraSourceBase();
    ...
    public CameraSourceBase start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSourceBase start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
